...
spec_scr EQU $9000			; Начало экранного ОЗУ ПК Специалист
spec_scr_left_shift EQU $08	; Отступ знакомест слева для размещения ZX-экрана
spec_scr_top_shift EQU $20	; Отступ пикселей сверху для размещения ZX-экрана

; Адрес начала окна ZX-экрана на экране Специалиста
zx_scr EQU spec_scr+spec_scr_left_shift*256+spec_scr_top_shift	; $9820
...
clear_screen_pix:		; Specialist ready
  LD HL,$0000
  LD D,H
  LD E,L
  ADD HL,SP
  LD (clear_screen_1+$01),HL
  LD HL,zx_scr+$20*$100+$c0
  LD C,$20
clear_screen_3:
  DEC H
  LD SP,HL
...
all_metal_briks_frame:
  ...
  LD HL,zx_scr+$0120 ; Адрес в экранной области начала рисования кирпичей
  LD B,$0C
LAD8F_0:
  PUSH BC
  PUSH HL
...
screen_addr_calc:		; Specialist ready
	ld a,l
	rra
	rra
	rra
...
end_bin:
	IFDEF MX
	savebin "batty.i80",start_bin,end_bin-start_bin
	ELSE
	savebin "batty.bin",start_bin,end_bin-start_bin
	ENDIF

	display "spr_brik_1: ", spr_brik_1